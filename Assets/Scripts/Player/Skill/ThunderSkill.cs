...
using UnityEngine;
[CreateAssetMenu(fileName = "New Skill", menuName = "Skill/Thunder Skill")]
public class ThunderSkill : SkillObject
{
    ...
    IEnumerator PlaySkillAnimation(Animator anim, int skillToActivate, List<GameObject> g)
    {
        ...
        anim.gameObject.GetComponent<SphereCollider>().radius *= 2;
